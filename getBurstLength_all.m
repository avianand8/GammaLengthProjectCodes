function [lengthList,freqList,timeList,gaborInfo,header,modList] = getBurstLength_all(analogData,timeVals,thresholdFactor,displayFlag,stimulusPeriodS,baselinePeriodS,burstFreqRangeHz,maxIteration,adaptiveDictionaryParam,dictionarySize,gaborInfo,header,algName)
...
if isempty(gaborInfo)
    ...
    [gaborInfo,header] = getStochasticDictionary_all(analogData1,timeVals,maxIteration,adaptiveDictionaryParam,dictionarySize,algName);
end
